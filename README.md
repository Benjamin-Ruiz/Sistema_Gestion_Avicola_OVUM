...
El proyecto está construido bajo los estándares de desarrollo Android:
...
2. **Abrir en Android Studio:**
   Importa el proyecto y permite que Gradle descargue las dependencias.
...
Las contribuciones son bienvenidas. Si desea mejorar algún módulo o corregir un error:
1. Realice un Fork del proyecto.
2. Cree una rama para su mejora (`git checkout -b feature/NuevaMejora`).
3. Realice un Commit de sus cambios.
4. Realice un Pull Request.
...
**Desarrolladores:**
* **Benjamín Ruiz** - [Perfil de GitHub](https://github.com/Benjamin-Ruiz)
* **Dom-cs13** - [Perfil de GitHub](https://github.com/Dom-cs13)
